...
namespace BackEnd_API.Controllers.AdminControllers
{
    ...
    public class SocialController : AdminBaseController
    {
        ...
        public async Task<ActionResult<ResponseResult>> GetSocialAsync([FromBody] long Id)
            => await _mediator.Send(new GetSocialRequest { Id = Id });


        [HttpPost(ApiRouteV1.Social_Add, Name = "AddSocialAsync")]
        public async Task<ActionResult<ResponseResult>> AddSocialAsync([FromBody] CreateSocialDTO createSocialDTO)
        ...
        public async Task<ActionResult<ResponseResult>> UpdateSocialAsync([FromBody] UpdateSocialDTO updateSocialDTO)
        ...
        public async Task<ActionResult<ResponseResult>> DeleteSocialAsync([FromBody] long Id)
