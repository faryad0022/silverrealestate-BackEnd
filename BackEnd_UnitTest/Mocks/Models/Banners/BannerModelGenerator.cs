...
namespace BackEnd_UnitTest.Mocks.Models.Banners
{
    public static class BannerModelGenerator
    {
        ...
        public static CreateBannerDTO createBannerDTO_UploadError_InValid = new CreateBannerDTO
        {
            BannerImage = "",
            Link = "",
            Alt="kjlkj"
