...
{
    public class DeleteBannerRequestHandler_Test
    {
        private readonly IMapper _mapper;
        private readonly Mock<IUnitofWork> _mock;
        public DeleteBannerRequestHandler_Test()
        {
        ...
        [Fact]
        public async Task DeleteBanner_Valid()
        {
            var handler = new DeleteBannerRequestHandler(_mapper, _mock.Object);
        ...
        [Fact]
        public async Task DeleteBanner_NotFound_InValid()
        {
            var handler = new DeleteBannerRequestHandler(_mapper, _mock.Object);
