...
{
    public class ChangeCommonQuestionSelectedStatusRequestHandler_Test
    {
        private readonly IMapper _mapper;
        private readonly Mock<IUnitofWork> _mock;
        public ChangeCommonQuestionSelectedStatusRequestHandler_Test()
        {
        ...
        [Fact]
        public async Task ChangeCommonSelected_Valid()
        {
            var handler = new ChangeCommonQuestionSelectedStatusRequestHandler(_mapper, _mock.Object);
        ...
        [Fact]
        public async Task ChangeCommonSelected_NotFound_InValid()
        {
