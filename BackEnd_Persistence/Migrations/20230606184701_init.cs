    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, "+98-9123071411", new DateTime(2023, 6, 6, 22, 17, 0, 578, DateTimeKind.Local).AddTicks(8954), "mahancomputer49@gmail.com", false, true, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "کیش - شهرک صدف - خیابان سبلان - پلاک 27 - واحد6", "00987644446503", "شنبه تا جمعه ساعت 8-20" },
                    { 2L, "+90-5338355243", new DateTime(2023, 6, 6, 22, 17, 0, 578, DateTimeKind.Local).AddTicks(9024), "mahancomputer49@gmail.com", false, true, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "قبرس شمالی - شهرک رویال سان - پرل 105", "00987644446503", "شنبه تا جمعه ساعت 8-20" }
                });

            migrationBuilder.InsertData(
                table: "Banners",
                columns: new[] { "Id", "CreateDate", "Description", "Header", "IsDelete", "IsSelected", "LastUpdateDate", "PhoneLogo", "RealEstateLogo", "ShortText", "Text" },
                values: new object[] { 1L, new DateTime(2023, 6, 6, 22, 17, 0, 579, DateTimeKind.Local).AddTicks(5770), "تا پایان خرداد", "آفرهای ویژه", false, true, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "phone.jpg", "silver.jpg", "تا فرصت هست از آفرهای ویژه شرکت استفاده کنید", "با خرید ملک مبلمان رایگان دریافت کنید" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, new DateTime(2023, 6, 6, 22, 17, 0, 580, DateTimeKind.Local).AddTicks(9889), false, true, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "اخبار قبرس" },
                    { 2L, new DateTime(2023, 6, 6, 22, 17, 0, 581, DateTimeKind.Local).AddTicks(356), false, true, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "دانشگاه های قبرس" },
                    { 3L, new DateTime(2023, 6, 6, 22, 17, 0, 581, DateTimeKind.Local).AddTicks(366), false, true, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "کنسرت ها" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, "قبرس با داشتن آب و هوای معتدل و مرطوب مدیترانه ایی مقصد مورد علاقه جهانگردان برای تعطیلات می باشد، با داشتن بیش از ۳۰۰ روز آفتابی و گرمایی مطلوب و کوهستان هایی در دل خود، از اعتدالی مدیترانه ایی برخوردار است.", new DateTime(2023, 6, 6, 22, 17, 0, 581, DateTimeKind.Local).AddTicks(5838), false, true, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "قبرس کجاست؟" },
                    { 2L, "قبرس شمالی با داشتن ۳۶ درصد از مساحت کل جزیره قبرس به علت داشتن شرایط مهاجرتی آسان و مالیات بسیار کم در قیاس با جمهوری قبرس و سایر کشورهای اروپایی مورد توجه سرمایه گذارانی از نقاط مختلف دنیا قرار گرفته است", new DateTime(2023, 6, 6, 22, 17, 0, 581, DateTimeKind.Local).AddTicks(6780), false, true, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "چرا قبرس شمالی؟" },
                    { 3L, "لیر ترکیه به عنوان ارز رایج این کشور شناخته می شود ولی خرید فروش ملک به پوند انگلستان می باشد و دلار و یورو هم در کنار این دو واحد پولی مورد استفاده قرار می گیرد.", new DateTime(2023, 6, 6, 22, 17, 0, 581, DateTimeKind.Local).AddTicks(6790), false, true, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "واحد پولی قبرس شمالی چه می باشد؟" },
                    { 4L, "امنیت بالای قبرس شمالی در کنار رفاه مردم این کشور می تواند برای هر خانواده ایی دلیلی مناسب برای مهاجرت به قبرس شمالی باشد، بی علت نیست اگر قبرس شمالی در فهرست پنج کشور امن دنیا قرار گرفته است.", new DateTime(2023, 6, 6, 22, 17, 0, 581, DateTimeKind.Local).AddTicks(6793), false, true, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "آیا قبرس شمالی برای زندگی خانوادگی مناسب می باشد؟" },
                    { 5L, "برای ورود به قبرس شمالی به صورت توریستی نیازی به اخذ ویزا نخواهید داشت.  برای داشتن اقامت بیشتر، از طریق اقامت دانشجویی، خرید ملک و یا ثبت شرکت و یا اشتغال میسر خواهد بود.", new DateTime(2023, 6, 6, 22, 17, 0, 581, DateTimeKind.Local).AddTicks(6795), false, true, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "شرایط اخذ ویزا برای ورود به قبرس شمالی چگونه می باشد؟" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, new DateTime(2023, 6, 6, 22, 17, 0, 583, DateTimeKind.Local).AddTicks(1705), "The Best real estate in cyprus", "silver.jpg", false, true, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Silver Net Real Estate" },
                    { 2L, new DateTime(2023, 6, 6, 22, 17, 0, 583, DateTimeKind.Local).AddTicks(1737), "The Best real estate in cyprus", "silver-net.jpg", false, false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Silver Net Real Estate" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, new DateTime(2023, 6, 6, 22, 17, 0, 584, DateTimeKind.Local).AddTicks(2146), "fa fa-instagram", false, true, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "instagram.com", "Instagram" },
                    { 2L, new DateTime(2023, 6, 6, 22, 17, 0, 584, DateTimeKind.Local).AddTicks(2182), "fa fa-facebok", false, true, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "facebook.com", "Facebook" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, new DateTime(2023, 6, 6, 22, 17, 0, 584, DateTimeKind.Local).AddTicks(8787), false, true, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Ghost City" },
                    { 2L, new DateTime(2023, 6, 6, 22, 17, 0, 584, DateTimeKind.Local).AddTicks(8806), false, true, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Wall City" },
                    { 3L, new DateTime(2023, 6, 6, 22, 17, 0, 584, DateTimeKind.Local).AddTicks(8809), false, false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Long Beach" },
                    { 4L, new DateTime(2023, 6, 6, 22, 17, 0, 584, DateTimeKind.Local).AddTicks(8811), false, false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Casino" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, "09123071411", new DateTime(2023, 6, 6, 22, 17, 0, 585, DateTimeKind.Local).AddTicks(6544), "mahancomputer49@gmail.com", false, true, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "faryad.jpg", "CEO", "Faryad" },
                    { 2L, "09352499091", new DateTime(2023, 6, 6, 22, 17, 0, 585, DateTimeKind.Local).AddTicks(6584), "faryad.abolhassani@yahoo.com", false, true, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "farzad.jpg", "CEO", "Farzad" },
                    { 3L, "09122895170", new DateTime(2023, 6, 6, 22, 17, 0, 585, DateTimeKind.Local).AddTicks(6593), "Mojgan.Nazari@gmail.com", false, true, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "mojgan.jpg", "Sell Manager", "Mojgan" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, new DateTime(2023, 6, 6, 22, 17, 0, 586, DateTimeKind.Local).AddTicks(4745), "fa fa-instagram", false, true, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "faryad/Instagram.com", "Instagram", 1L },
                    { 2L, new DateTime(2023, 6, 6, 22, 17, 0, 586, DateTimeKind.Local).AddTicks(4762), "fa fa-facebook", false, true, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "faryad/FaceBook.com", "Facebook", 1L },
                    { 3L, new DateTime(2023, 6, 6, 22, 17, 0, 586, DateTimeKind.Local).AddTicks(4766), "fa fa-tiktok", false, false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "faryad/TikTok.com", "TikTok", 1L }
                });
